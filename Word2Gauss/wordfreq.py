...
def separateSentencesIntoWords(sentence):
    ...
    # remove punctuation
    for word in words:
        refinedWord = word.strip(string.punctuation).lower()
...
wordsToFrequence("/media/arlind/Windows/Users/Lindarx/Desktop/CAR_EEG/P1/linguistic_information/P1_07_09_2016_anonymisiert.xls")
print(len(wordFrequenciesDict))
wordsToFrequence("/media/arlind/Windows/Users/Lindarx/Desktop/CAR_EEG/P2/linguistic_information/P2_07_09_2016_anonymisiert.xls")
print(len(wordFrequenciesDict))
wordsToFrequence("/media/arlind/Windows/Users/Lindarx/Desktop/CAR_EEG/P3/linguistic_information/P3_07_09_2016_anonymisiert.xls")
print(len(wordFrequenciesDict))
wordsToFrequence("/media/arlind/Windows/Users/Lindarx/Desktop/CAR_EEG/P4/linguistic_information/P4_11_10_2016_anonymisiert.xls")
print(len(wordFrequenciesDict))
